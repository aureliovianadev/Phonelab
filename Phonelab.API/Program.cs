using System.Text;
using Phonelab.API.Data;
using Phonelab.API.Middleware;
using Phonelab.API.Models;
using Phonelab.API.Services.Implementations;
using Phonelab.API.Services.Interfaces;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Phonelab v1");
